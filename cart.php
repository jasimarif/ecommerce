...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.css">
  ...
  <form class="form-inline">
    ...
    <button class="btn btn-sm btn-outline-primary" type="button">Sign In</button>
        ...
        Welcome guest! <b style="color:yellow"> Shopping cart Total Items: <?php total_cart();?> - Total Price: <?php totalCart_price();?> </b> <a href="cart.php" style="color: blue" > Go to cart</a>
