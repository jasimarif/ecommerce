...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.css">
  ...
  <body>
    ...
    <button type="button" id="sidebarCollapse" class="btn btn-light btn"> 
        ...
        <div id="product_box"> 
            ...
            while($row_pro=mysqli_fetch_array($run_pro))
            {
                ...
                echo "
                    ...
                    <a href='index.php' <button class='btn btn-sm mx-4 btn-primary' style:'float:right'> Go back </button></a>
                    <p> PKR $pro_price </p>
