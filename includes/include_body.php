...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.css">
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        ...
        <?php
        include("includes/include_my_account.php");
          ?>
  ...
  <form class="form-inline">
    <?php
        include("includes/include_toggle_logout.php");
        ...
        ?>
         ...
         <span style="float: right; padding:5px; line-height: 40px; font-size: 18px;" >  
            <?php
            include("includes/welcome_guest.php");
             
             ?>
             <a href="cart.php" style="color: blue" > Go to cart</a>
